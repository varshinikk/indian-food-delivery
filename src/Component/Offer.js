...
{/* <div class="row">
                <div class="col-sm-4 col-lg-4 col-md-4 col-xs-4">
                    ...
                    <div class="card-body">
                        <img className="food2" src={require('../Image/food10.jpg')} alt="no image" /><br />
                        <h3></h3>
                    </div>
                    </div>
                </div>
                <div class="col-sm-4 col-lg-4 col-md-4 col-xs-4">
                    ...
                    <div class="card-body">
                        <img className="food2" src={require('../Image/food11.jpg')} alt="no image" /><br />
                        <h3>Sweet Pongal</h3>
                    </div>
                    </div>
                </div>
                <div class="col-sm-4 col-lg-4 col-md-4 col-xs-4">
                    <div class="card" >
                    <div class="card-body">
                        <img className="food2" src={require('../Image/food12.jpeg')} alt="no image" /><br />
                        <h3>Veg Soup</h3>
                    </div>
                    </div>
                </div>
